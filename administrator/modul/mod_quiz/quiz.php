      ...
      $tgl_buat   = tgl_indo($r[tgl_buat]);
       echo "<tr><td>$no</td>
             ...
             <td><ul><li><a href='?module=quiz&act=edittopikquiz&id=$r[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /></a> | 
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapustopikquiz&id=$r[id_tq]') title='Hapus'><img src='images/icons/cross.png' alt='Delete' /></a> | <a href=javascript:print title='Print'><img src='images/icons/Print.png' alt='Print' /></a></li>
            ...
            echo "<tr><td>$no</td>
                      ...
                      if ($t[dikoreksi]=='B'){
                          echo "<td>
                                    Nilai Tugas/Quiz Pilihan Ganda : $n2[persentase]</td>";
                          echo "
                          <td><a href=$aksi?module=quiz&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Siswa</a> </td></tr>";
                      }else{
                          echo "<td>Nilai Tugas/Quiz Pilihan Ganda : $n2[persentase]
                                                         </td>";
                          echo "
...
case "infokerjakan":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        echo"<br><b class='judul'>Informasi</b><br><p class='garisbawah'></p>
            ...
            3. Pilih browser yang suport dengan Ujian Online SMPN 1 Karangrejo yaitu Mozilla Firefox.<br>
...
case "buatquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo"<fieldset>
             ...
             <dl class='inline'>
             <dt><label>Pertanyaan ".$jumlah." </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'></textarea></dd>
             <dt><label>Gambar Pertanyaan</label></dt>            <dd><input type=file name='fupload' size=100>
    ...
    while ($q=mysql_fetch_array($quiz)){
       echo "<tr><td rowspan=8><b>$no.</b></td>
             ...
             if (empty($q[gambar])){
                 ...
                 echo "<tr><td>Gambar</td><td>: $q[gambar]<ul class='photos sortable'>
                    <li>
